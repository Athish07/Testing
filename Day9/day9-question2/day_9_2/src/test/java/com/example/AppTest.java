...
public class AppTest 
{
    ...
    void beforeTest()
    {
        ExtentSparkReporter sparkReporter=new ExtentSparkReporter("D:\\Class work\\Day9\\day9-question2\\report.html");
    ...
    void teardown(ITestResult result) throws Exception
    {
        ...
        String screenShotPath="D:Class work\\Day9\\day9-question2\\"+result.getName()+".png";
