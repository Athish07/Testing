...
public class AppTest 
{
    ...
    void beforeTest()
    {
        ExtentSparkReporter sparkReporter=new ExtentSparkReporter("D:\\Class work\\Day9\\day9-question1\\report.html");
    ...
    void teardown(ITestResult result) throws Exception
    {
        ...
        String screenShotPath="D:\\Class work\\Day9\\day9-question1"+result.getName()+".png";
    ...
    {
        FileInputStream fs=new FileInputStream("D:\\Class work\\Day9\\day9-question1\\loanamount.xlsx");
